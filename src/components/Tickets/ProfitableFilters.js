  ...
  render () {
    ...
    return (
      <div className="tickets-buttons">
          <button className={buttonLeftStyle} onClick={this.handleSetTicketsProfitableFilter('cheapest')}>САМЫЕ ДЕШЕВЫЕ</button>
          <button className={buttonRightStyle} onClick={this.handleSetTicketsProfitableFilter('fastest')}>САМЫЕ БЫСТРЫЕ</button>
      </div>
    );
