...
export const setTicketsProfitableFilter = createAction('TICKETS_PROFITABLE_FILTER_SET');
export const setTicketsTransplantsFilter = createAction('TICKETS_TRANSPLANTS_FILTER_SET');
